...
public class Ex10Data extends HttpServlet {
	...
	private void m5(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<AddressDTO> list = dao.listAddress(); //오브젝트
		...
		//[{"address":"서울시 강남구 역삼동","name":"한선선","age":"31"},{"address":"서울시 강서구 둔촌동","name":"경선한","age":"29"},{"address":"서울시 강남구 역삼동","name":"현최정","age":"30"},{"address":"서울시 강남구 역삼동","name":"한선선","age":"31"},{"address":"서울시 은평구 불광동","name":"김경박","age":"38"}]
	...
	private void m4(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//ex07data 79줄에 있는거 안해도 됨(너무 노가다) -> 이렇게 해버리면 json으로 들어가짐
		//{"question":"가장 자신있는 프로그래밍 언어는?","seq":"1"}
	...
	private void m3(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//System.out.println(req.getParameter("txt1")); <- 안됨
