...
public class AjaxDAO {
	...
	public boolean checkCell(Ex11DTO dto) {
		...
		try {
			...
			String sql = "select count(*) as cnt from ajaxTable" + " where x = ? and y = ?";
	...
	public Ex13DTO getProduct() {
		...
		try {
			...
			String sql = "select seq, pic from tblProduct" + " where seq = (select max(seq) from tblProduct)";
	...
	public List<Q04DTO> getCat() {
		try {
			...
			List<Q04DTO> list = new ArrayList<Q04DTO>();
